...
// 图片推荐位
User.hasMany(ImgRP,   { foreignKey: 'userId', targetKey: 'id', as: 'ImgRP' })	// 用户关联推荐位
...
// 文字推荐位
User.hasMany(TxtRP,   { foreignKey: 'userId', targetKey: 'id', as: 'TxtRP' })	// 用户关联推荐位
...
// 模板管理
User.hasMany(Temp,   { foreignKey: 'userId', targetKey: 'id', as: 'Temp' })		// 用户关联模板类
